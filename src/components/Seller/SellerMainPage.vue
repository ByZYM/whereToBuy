<template>
	<div class="container">
		...
		<div id="manage">
			<div class="myrow">
				<div class="mybutton">
					<img src="../../assets/ico/店铺 (1).png" />
					我的商铺
				</div>
				<div class="mybutton">
					<img src="../../assets/ico/礼品 (1).png" />
					添加商品
				</div>
				<div class="mybutton">
					<img src="../../assets/ico/客户.png" />
					评论回复
				</div>
			</div>
			<div class="myrow">
				<div class="mybutton">
					<img src="../../assets/ico/火箭.png" />
					商品管理
				</div>
				<div class="mybutton">
					<img src="../../assets/ico/商品.png" />
					所有商品
				</div>
				<div class="mybutton">
					<img src="../../assets/ico/信息.png" />
					个人信息
				</div>
			</div>
		</div>
